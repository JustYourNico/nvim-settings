...
vim.api.nvim_set_keymap('n', '<C-h>', '<cmd>lua vim.lsp.buf.hover()<CR>', options)
...
vim.api.nvim_set_keymap('n', '<C-k>', '<cmd>lua vim.diagnostic.open_float(0, { scope = "cursor" })<CR>', options)
